...
#define RH_PLATFORM_ARDUINO_NANO_EVERY 21
						   
////////////////////////////////////////////////////
// Select platform automatically, if possible
#ifndef RH_PLATFORM
 #if defined(__AVR_ATmega4809__) || defined(ARDUINO_AVR_NANO_EVERY)
  #define RH_PLATFORM RH_PLATFORM_ARDUINO_NANO_EVERY
 #elif (defined(MPIDE) && MPIDE>=150 && defined(ARDUINO))
...
#if (RH_PLATFORM == RH_PLATFORM_ARDUINO_NANO_EVERY)
  #pragma message "Compiling for Arduino Nano Every"
#else
  #pragma message "Not compiling for Arduino Nano Every"
#endif
...
// Platform specific headers:
  ...
  // Optionally, if you need to define which timer to use for RH_ASK,
  // you can add something like:
  #define RH_NANO_EVERY_ASK_TIMER TCB0
  #define RH_NANO_EVERY_ASK_TIMER_VECTOR TCB0_INT_vect
